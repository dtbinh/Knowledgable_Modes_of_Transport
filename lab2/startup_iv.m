...
addpath(fullfile(IV_BASE_PATH, 'utils')); % add generic useful functions
addpath(fullfile(IV_BASE_PATH, 'utils_iv')); % add functions for IV course

% disable confusing warnings on 'axis equal' command in Matlab R2016a.
